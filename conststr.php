...
$constStr = [
    ...
    'SetSecretsFirst' => [
        ...
        'vi-vi' => 'Set API in Config first! or reinstall.',
    ...
    'RefreshtoLogin' => [
        ...
        'vi-vi' => '<font color="red">Refresh</font> and login.',
    ...
    'SetpassfileBfEncrypt' => [
        ...
        'vi-vi' => 'Set \'passfile\' in Environments before encrypt',
    ...
    'CopyDisk' => [
        ...
        'vi-vi' => 'Copy this Disk',
    ],
    'RenameDisk' => [
        'en-us' => 'Rename Disk Tag',
        'vi-vi' => 'Rename Disk Tag',
        'zh-tw' => '修改標籤',
        'ar-sa' => 'تغيير التسمية',
    ],
    'ChangeDrivetype' => [
    ...
    'NeedUpdate' => [
        ...
        'vi-vi' => 'Program can update<br>Click setup in Operate at top.',
    ...
    'FileNotSupport' => [
        ...
        'vi-vi' => 'File not support preview.',
        'zh-tw' => '檔案格式不支援預覽',
    ...
    'UploadErrorUpAgain' => [
        ...
        'vi-vi' => 'Maybe error, do upload again.',
        'zh-tw' => '可能出錯，重新上傳。',
    ...
    'defaultSitename' => [
        'en-us' => 'Trang data - Bạn không giỏi',
    ],
    'SavingToken' => [
        'en-us' => 'Saving refresh_token!',
        'vi-vi' => 'Saving refresh_token!',
    ...
    'MayinEnv' => [
        ...
        'vi-vi' => 'The \'Drive_ver\' may in Config',
    ...
    'WaitJumpIndex' => [
        ...
        'vi-vi' => 'Wait 5s jump to Home page',
        'zh-tw' => '等5秒跳到首頁',
    ...
    'JumptoOffice' => [
        ...
        'vi-vi' => 'Login Office and Get a refresh_token',
    ...
    'DriveVerMS' => [
        ...
        'vi-vi' => 'Onedrive, Onedrive for business',
        'zh-tw' => '國際版（商業版與個人版）',
        'ja' => '国際版（商業版と個人版）',
    ...
    'GetSecretIDandKEY' => [
        ...
        'vi-vi' => 'Get custom client id & secret',
        'zh-tw' => '申請應用ID與機密',
    ...
    'UseSharepointInstead' => [
        ...
        'vi-vi' => 'Use space in Sharepoint website instead of Onedrive',
    ...
    'GetSharepointSiteAddress' => [
        ...
        'vi-vi' => 'Login office.com and click the SharePoint, create a website or find an exist website, input the Site address below',
    ...
    'TagFormatAlert' => [
        ...
        'vi-vi' => 'Tag must start with a letter, end with a letter or digit and can only contain lowercase letters, digits, and dashes， at least 2 letters!',
    ...
    'ClickInstall' => [
        ...
        'vi-vi' => 'Click to install the project',
        'zh-tw' => '點擊開始安裝程式',
    ...
    'LogintoBind' => [
        ...
        'vi-vi' => 'then login and bind your onedrive in setup',
    ...
    'MakesuerWriteable' => [
        ...
        'vi-vi' => 'Plase make sure the config.php is writeable. run writeable.sh.',
    ...
    'MakesuerRewriteOn' => [
        ...
        'vi-vi' => 'Plase make sure the RewriteEngine is On',
        'zh-tw' => '確認重寫（偽靜態）功能啟用',
    ...
    'RefreshCache' => [
        ...
        'vi-vi' => 'Refresh Cache of Current Folder',
        'zh-tw' => '重新整理当前資料夾快取',
        'ja' => 'キャッシュを再構築',
        'ko-kr' => '캐시 플러시',
        'fa' => 'رفرش cache',
    ...
    'CannotOneKeyUpate' => [
        ...
        'vi-vi' => 'Can not update by a click! run update.sh',
    ...
    'ChangAdminPassword' => [
        ...
        'vi-vi' => 'Chang Admin Password',
        'zh-tw' => '修改管理密碼',
    ],
    'AdminPassword' => [
        'en-us' => 'Admin Password',
        'vi-vi' => 'Admin Password',
        'zh-tw' => '管理密碼',
    ],
    'export' => [
        'en-us' => 'export',
    ...
    'ONEMANAGER_CONFIG_SAVE_ENV' => [
        ...
        'vi-vi' => 'Config save in Environments',
        'zh-tw' => '配置儲存在環境變數',
    ],
    'ONEMANAGER_CONFIG_SAVE_FILE' => [
        'en-us' => 'Config save in code file, may cause fee, please reinstall later',
        'vi-vi' => 'Config save in code file, may cause fee, please reinstall later',
